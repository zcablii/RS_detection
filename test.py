...
alter("configs/preprocess/fair1m_1_5_preprocess_config_ms_le90_test.py", 'source_dataset_path', 'source_dataset_path = "'+dota_paht+'"#')
alter("configs/preprocess/fair1m_1_5_preprocess_config_ms_le90_test.py", 'target_dataset_path', 'target_dataset_path = "'+args.preprocessed_path+'"#')
alter("configs/orcnn_van3_for_test_1.py", 'images_dir', 'images_dir = "' + args.preprocessed_path + '",#')
alter("configs/orcnn_van3_for_test_2.py", 'images_dir', 'images_dir = "' + args.preprocessed_path + '",#')
